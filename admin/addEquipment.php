...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO equipment (name, description, brand, rental_price, stock, images) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param('sssdis', $name, $description, $brand, $rental_price, $stock, $images_json);
